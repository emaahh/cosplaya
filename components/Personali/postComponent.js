        ...
        <>
            ...
            <Dialog open={largeFoto} onOpenChange={setLargeFoto} className="rounded">
                <DialogContent className="rounded">
                    ...
                    <DialogDescription>
                        <img className=" w-full self-center object-contain  rounded" src="https://i.pinimg.com/736x/99/4e/8c/994e8c6c41cb42597b63f0f2387e1794.jpg" />
                    </DialogDescription>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
            ...
            <Card className="w-fit overflow-hidden mb-5">
                ...
                <CardContent className="flex justify-center">
                    <Carousel className="sm:w-[70%] w-[90%] max-w-[400px]">
                        ...
                        <div className="w-full flex justify-center items-center absolute bottom-5">
                            <Button adjustColor="rgb(100, 116, 139)" className="rounded-full w-10 h-10 sm:w-12 sm:h-12 p-3 border-slate-500 border-spacing-1 opacity-50" onClick={() => setLargeFoto(true)} ><Maximize2 className="bg-[transparent!important]"/></Button>
                        </div>
                    </Carousel>
                </CardContent>
